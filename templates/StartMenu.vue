...
<div class="menu" style="z-index: 1000000">
    ...
    <div class="socials">
        ...
        <a href="https://www.linkedin.com/in/demisk" target="_blank">
            <div class="bar">
                <img class="social-image" src="@/assets/iPhone-Icons/Linkedin.webp" />
                <u>L</u>inkedIn
            </div>
        </a>
        <a href="https://x.com/programmingbao" target="_blank">
            <div class="bar">
                <img class="social-image" src="@/assets/iPhone-Icons/Twitter.webp" />
                <u>T</u>witter
            </div>
        </a>
        <a href="https://github.com/demis1997" target="_blank">
            <div class="bar">
        ...
        <a href="/files/dimitriscv.pdf" target="_blank">
            <div class="bar">
